...
The `a11y-audit` agent owns phase numbering. During a phased deep-dive audit, this skill runs after **Phase 4 (Forms)** or immediately before Phase 11 if deferred. Complete one pass: apply the checklist, return findings, and stop. Do not start another phase.
...
## Step 2 - WCAG 2.2 Success Criteria Assessment
...
## Step 3 - COGA Guidance Assessment
